 ...
 * the License.
 */
package net.byte2data.webtech.vaadin.ui.views.categorieslist;
...
import net.byte2data.webtech.vaadin.backend.Category;
import net.byte2data.webtech.vaadin.backend.CategoryService;
