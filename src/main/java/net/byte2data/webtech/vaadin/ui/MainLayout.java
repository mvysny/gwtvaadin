 ...
 * the License.
 */
package net.byte2data.webtech.vaadin.ui;
...
import net.byte2data.webtech.vaadin.ui.views.categorieslist.CategoriesList;
import net.byte2data.webtech.vaadin.ui.views.reviewslist.ReviewsList;
