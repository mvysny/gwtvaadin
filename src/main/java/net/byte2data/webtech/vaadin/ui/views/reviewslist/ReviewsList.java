 ...
 * the License.
 */
package net.byte2data.webtech.vaadin.ui.views.reviewslist;
...
import net.byte2data.webtech.vaadin.backend.Review;
import net.byte2data.webtech.vaadin.backend.ReviewService;
import net.byte2data.webtech.vaadin.ui.MainLayout;
import net.byte2data.webtech.vaadin.ui.common.AbstractEditorDialog;
import net.byte2data.webtech.vaadin.ui.encoders.LocalDateToStringEncoder;
import net.byte2data.webtech.vaadin.ui.encoders.LongToStringEncoder;
import net.byte2data.webtech.vaadin.ui.views.reviewslist.ReviewsList.ReviewsModel;
